  ...
  <div class="px-3 py-2 mb-3">
    <div class="container d-flex flex-wrap justify-content-center">
      ...
      <ul class="nav col-12 col-md-auto justify-content-center text-small">
        ...
        <li>
          <a href="{{ route('writer.dashboard') }}" class="nav-link text-secondary">
            <svg class="bi d-block mx-auto mb-1" width="24" height="24">
        ...
        <!-- Create Article -->
        <li>
          <a href="{{ route('articles.create') }}" class="nav-link text-secondary">
            <svg class="bi d-block mx-auto mb-1" width="24" height="24">
              <use xlink:href="#grid" />
            </svg>
            Crea Articolo
        ...
        <li>
          <a href="{{ route('revisor.dashboard') }}" class="nav-link text-secondary">
            <svg class="bi d-block mx-auto mb-1" width="24" height="24">
              <use xlink:href="#speedometer2" />
            </svg>
            Dashboard
  ...
  <div class="px-3 py-2  mb-3">
    <div class="container d-flex flex-wrap justify-content-center">
      ...
      <div class="text-end">
        ...
        <button type="button" class="btn btn-success text-dark me-3">
